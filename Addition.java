...
public class Addition // cria a classe de adição 
{
   public static void main(String[] args) // cria o método de de execussão 
   {
      ...
      String firstNumber = // prepara a primeira classe para receber o primeiro número 
         JOptionPane.showInputDialog("Digite o primeiro número"); // exibe uma caixa de diálogo onde solicita para digigitar o primeiro número inteiro, alem de mostrar o botçao de "ok" e "cancel"
      String secondNumber =// prepara a segunda classe para receber o segundo o número 
         JOptionPane.showInputDialog("Digite o segundo número"); // exibe uma caixa de diálogo onde solicita para digigitar o segundo número inteiro, alem de mostrar o botçao de "ok" e "cancel"
      ...
      JOptionPane.showMessageDialog(null, "A soma dos números é:" + sum, // exibe o resultado da soma  
         "Soma de dois inteiros", JOptionPane.PLAIN_MESSAGE); // mostra a uma janela com o texto 
   } 
